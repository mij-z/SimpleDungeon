...
public class QuitOption extends SubMenu {
    ...
    public QuitOption(JFrame frame) {
        this.frame = frame;

        try {
            URL imgURL = getClass().getResource("/menu/quit_button.png");
            assert imgURL != null;

            URL imgActiveURL = getClass().getResource("/menu/quit_button_active.png");
